...
// DB interface wraps the databse
type DB interface {
	EnsureIndices(ctx context.Context, inds []interface{}) error
	Insert(ctx context.Context, table string, v interface{}) error
	InsertMany(ctx context.Context, table string, v []interface{}) error
	FindMany(ctx context.Context, table string, filter interface{}, skip, limit int64, v interface{}, sort ...interface{}) error
	FindOne(ctx context.Context, table string, filter DbQuery, v interface{}, sort ...interface{}) error
	UpdateMany(ctx context.Context, table string, filter DbQuery, data interface{}) error
	UpdateOne(ctx context.Context, table string, filter DbQuery, data interface{}) error
	//PartialUpdateManyByQuery(ctx context.Context, col string, filter DbQuery, query UnorderedDbQuery) error
	//BulkUpdate(ctx context.Context, col string, models []mongo.WriteModel) error
	//Aggregate(ctx context.Context, col string, q []DbQuery, v interface{}) error
	//AggregateWithDiskUse(ctx context.Context, col string, q []DbQuery, v interface{}) error
